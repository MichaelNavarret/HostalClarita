            ...
            <?php
                if(isset($_POST['btn'])){
                    ...
                    if($state == 'Todos'){
                        ...
                        $consulta = "SELECT	OP.idOrdenPedido ID,
                                        ...
                                        CONVERT(VARCHAR,OP.fechaGenOrden,111 ) FECHA,
                                        OP.estado ESTADO,
                                        SUM(OPP.cantidad) CANT
                                FROM OrdenPedido AS OP
                                JOIN OrdenPedido_Producto AS OPP ON OP.idOrdenPedido = OPP.idOrdenPedido
                                WHERE rutProveedor = '$rutLog' AND OP.estado = '$state'
                                GROUP BY	OP.idOrdenPedido ,
                                            OP.detalle ,
                                            CONVERT(VARCHAR,OP.fechaGenOrden,111 ) ,
                                            OP.estado;";
                    ...
                    $consulta = "   SELECT	OP.idOrdenPedido ID,
                                ...
                                GROUP BY	OP.idOrdenPedido ,
                                            ...
                                            CONVERT(VARCHAR,OP.fechaGenOrden,111 ) ,
                                            OP.estado
                                ORDER BY OP.idOrdenPedido DESC;  
                                        ";
                }
                ...
                ?>
                    <tr class="filas">
                        ...
                        <td> <?php echo($cant); ?> </td>
                        <td>
                            <a href="buscarOrden.php?codigo=<?php echo($id) ?>&rutProveedor=<?php echo($rutLog); ?>">
