        ...
        <div class ="mainContainer">
            <div class="tablaProveedores">
                ...
                <dialog id ="popUpAgregar">
                    <form action="agregarProveedor.php" method="post" name="formAdd" id="formAdd">
                    ...
                    <p>Porfavor, evitar "ñ" y "tildes". Esto podria ocasionar que no se realice la insersión.</p>
                        <div class="campo">
                            ...
                            <input type="text" name="rutProv" id="rutProv" required minlength="9" maxlength="9">
                        </div>
                        <div class="campo">
                        ...
                        <div class="campo">
                            ...
                            <input type="text" name="direccion" id="direccion" required maxlength="50">
                        </div>
                        <div class="campo">
                            <label for="">Contraseña </label><br>
                            <input type="text" name="clave" id="clave" required maxlength="30">
                        </div>
                        <div class="campo">
                            <label for="rubro">Rubro</label><br><br>
                    ...
                    <?php
                        ...
                        while($fila=sqlsrv_fetch_array($ejectuar)){
                            ...
                            ?>
                                <tr id="contenido">
                                    <td><?php echo($rut); ?></td>
                                    <td class ="color"><?php echo(utf8_encode($direccion)); ?></td>
                                    <td><?php echo($nombre); ?></td>
                                    <td class ="color"><?php echo($rubro); ?></td>
                                    <td><?php echo($clave); ?></td>
                                    <td class ="color"> 
                                        <a href="editarProveedor.php?rutProveedor=<?php echo($rut); ?>&rutAdministrador=<?php echo($rutLog); ?>">
                                        ...
                                        <a href="borrarProveedor.php?rutProveedor=<?php echo($rut); ?>&rutAdministrador=<?php echo($rutLog); ?> " onclick="return eliminarProveedor()">
